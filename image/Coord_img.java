...
//format rinex pour passer d'un système image à terrain
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    BufferedImage img = ImageIO.read(new File("D:/G2_projet_info/Lighthouse.jpg"));
                    ...
                    Logger.getLogger(Coord_img.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
...
//source : http://stackoverflow.com/questions/25255287/mouse-coordinates-relative-to-imageicon-within-a-jscrollpane